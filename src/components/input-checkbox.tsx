...
export const inpoutCheckBoxWrapperVariants = tv({
  base: `
...
export const inputCheckboxVariants = tv({
  base: `
        ...
        cursor-pointer transition overflow-hiddern
    `,
  variants: {
    variant: {
      default: `
            border-2 border-solid
            border-border-primary over:border-border-active
...
export default function InputCheckbox({
  ...
  return (
    <label className={inpoutCheckBoxWrapperVariants({ className })}>
      <input
        type="checkbox"
